  ...
  return (
    <>
      <div className="men flex flex-col gap-8 px-4 md:px-10 py-10">
        ...
        <div className="main-content relative flex flex-col md:flex-row items-start gap-8">
          <button
          ...
          <div
            className={`top-0 left-0 md:sticky h-[100vh] z-30 transition-transform duration-300 ease-in-out ${
              isSidebarOpen ? "translate-x-0" : "-translate-x-full"
            } md:translate-x-0`}
          >
            <Filter closeSidebar={closeSidebar} className="top-0 left-0" />
          </div>
